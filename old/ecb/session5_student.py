...
def task_one():
    """
    This is an example of a wrapper function that reads in data from lusaka_ccd_gauge.txt
    and returns an array containing calibration parameters for each month
    ...
    calibration_params_all = np.zeros(shape=(len(months), 2))
