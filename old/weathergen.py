...
# Setting the threshold and the two sets of perturbations (to the mean and the standard deviation)
    threshold = 20
    perturbations_mean = np.array([[1,0.5,1,1],[1,0.5,1.5,1],[1,0.5,2,1],[1,0.5,2.5,1],[1,0.5,3,1],[1,0.5,10,1]])
    perturbations_sd = np.array([[1,0.5,1,1],[1,0.5,1,1.5],[1,0.5,1,2],[1,0.5,1,2.5],[1,0.5,1,3],[1,0.5,1,10]])
